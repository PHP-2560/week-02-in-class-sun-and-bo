...
Our group change the negative observations to NA, thus there will not be any negative rainfalls. Then we calculate the total rainfall of a day. And histogram looks better. 
